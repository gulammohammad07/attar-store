        ...
        <table className="w-full">
          ...
          <tbody>
            {occasions.map((occasion) => (
              <tr key={occasion.id} className="border-t border-[#111111]/10 hover:bg-[#f5f5f0]">
                <td className="p-4 text-sm font-medium text-[#111111]">{occasion.name}</td>
                <td className="p-4 text-sm text-[#111111]/60">{occasion.slug}</td>
                <td className="p-4">
                  {occasion.isActive ? (
            ...
            {occasions.length === 0 && (
              <tr>
                <td colSpan={4} className="p-8 text-center text-[#111111]/50">
                  No occasions yet.
                </td>
              </tr>
            )}
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <h3 className="font-medium text-[#111111]">{occasion.name}</h3>
                  <p className="mt-1 text-xs text-[#111111]/50">{occasion.slug}</p>
                  <p className="mt-2">
                    {occasion.isActive ? (
