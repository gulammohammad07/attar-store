        ...
        <table className="w-full">
          ...
          <tbody>
            {occasions.map((occasion) => (
              <tr key={occasion.id} className="border-t border-[#174a63]/10 hover:bg-[#f8fcfe]">
                <td className="p-4 text-sm font-medium text-[#174a63]">{occasion.name}</td>
                <td className="p-4 text-sm text-[#174a63]/60">{occasion.slug}</td>
                <td className="p-4">
                  {occasion.isActive ? (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <h3 className="font-medium text-[#174a63]">{occasion.name}</h3>
                  <p className="mt-1 text-xs text-[#174a63]/50">{occasion.slug}</p>
                  <p className="mt-2">
                    {occasion.isActive ? (
