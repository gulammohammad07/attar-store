        ...
        <div className="flex items-end justify-between gap-6">
          ...
          <div className="mb-14 flex gap-3">
            <button
              type="button"
              onClick={() => scroll(-1)}
              className="flex h-11 w-11 items-center justify-center rounded-full border border-[#1c1712]/20 text-[#1c1712] transition-colors hover:bg-[#1c1712] hover:text-white"
