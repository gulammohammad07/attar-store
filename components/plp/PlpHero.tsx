...
const floatingChips = [
  { top: "15%", right: "6%", label: "Pure Oud", delay: 1 },
  { top: "58%", right: "0%", label: "Hand-Poured", delay: 2 },
  { top: "70%", right: "30%", label: "Sun-Rested", delay: 3 },
];
      ...
      <div className="relative z-20 mx-auto grid w-full max-w-7xl items-center gap-6 px-6 pt-28 pb-24 lg:grid-cols-2 lg:gap-0 lg:pt-24 lg:pb-20">
        ...
        >
          ...
          >
            ...
            <span className="text-[11px] font-semibold tracking-[0.42em] text-gold uppercase">
              Premium
            </span>
